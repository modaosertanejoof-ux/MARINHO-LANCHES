...
async function main(){
  ...
  const restaurant = await prisma.restaurant.upsert({
    ...
    create:{
      ...
      description:'Lanches artesanais com sabor de mar e churrasco. Carne Angus, pão brioche e muito sabor.',
      ...
      whatsapp:'5518997124384',
      phone:'(18) 99712-4384',
      address:'Rua das Flores, 100 - Centro, Cândido Mota - SP',
      deliveryFee:5,
      minOrder:20,
  ...
  await prisma.user.upsert({where:{email:'dono@marinholanches.com'}, update:{}, create:{email:'dono@marinholanches.com', password:hashed, name:'Dono Modão', role:'owner', restaurantId:restaurant.id}})
